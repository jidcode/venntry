...
export function WarehousesTable<TData, TValue>({
  columns,
  data,
                    ...
                    <div>
                      {header.column.getCanSort() ? (
                        <button
                          ...
                          className="flex items-center gap-1 hover:text-accent transition-colors font-semibold uppercase text-xs tracking-wider"
                        >
                          {flexRender(
        ...
        {table.getRowModel().rows?.length ? (
          table.getRowModel().rows.map((row) => (
            <TableRow
              ...
              className="cursor-pointer hover:bg-muted/20 hover:text-accent"
