...
import NoWarehousesPage from "./_components/pages/no-warehouses-page";
...
import { WarehousesTable } from "./_components/data-table/warehouses-table";
  ...
  return (
    <>
      ...
      <div className="container mx-auto py-4">
        {warehouses && (
          <WarehousesTable columns={warehouseColumns} data={warehouses} />
        )}
      </div>
    </>
  );
